...
import SE_team.IssueManager.web.dto.ProjectMemberResponseDto.ProjectDevDto;
...
class ProjectMemberControllerTest {
        ...
        void addProjectMember() throws Exception {
                ...
                ProjectMemberResponseDto.ProjectMemberDTO projectMemberDTO = new ProjectMemberResponseDto.ProjectMemberDTO(
                                1L,
                                projectId, "member123",
        ...
        void getProjectDevs() throws Exception {
                ...
                when(projectMemberService.getProjectDevList(projectId))
                                .thenReturn(Arrays.asList("dev1", "dev2", "dev3"));
