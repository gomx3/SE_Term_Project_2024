...
class IssueServiceTest {
    ...
    void assign_fixer_test() {
        ...
        Issue updatedIssue = issueService.updateIssueState(plId, testIssue1.getId(), Status.ASSIGNED,
                dev.getMemberId());
    ...
    class fix_test {
        ...
        void fix_issue_not_dev() {
            ...
            assertThrows(IssueHandler.class,
                    () -> issueService.updateIssueState(memberId, testIssue1.getId(), Status.FIXED, ""));
        }
